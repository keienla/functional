...
export type UncurryArgs<Current extends ((...args: any[]) => any) | Curry<any>, Args extends any[] = [], Limit = 100, I extends any[] = [], Fn extends (...args: any[]) => any = Current extends Curry<infer fn> ? fn : Current, CurrentArgs extends Tuple = Fn extends (...args: infer U) => any ? U : []> = {
...
export type UncurryFinalType<Current extends (...args: any) => any, Limit = 100, I extends any[] = [], Fn extends (...args: any[]) => any = Current extends Curry<infer fn> ? fn : Current> = {
    last: ReturnType<Fn>;
...
export type Uncurry<Fn extends ((...args: any) => any) | Curry<any>, Args extends Tuple = Cast<UncurryArgs<Fn>, any[]>, Response = UncurryFinalType<Fn>> = (...args: Args) => IsFinite<Tuple<Response>, Response, any>;
