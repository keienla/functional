...
export type Compose<FNS extends [Fn, ...Fn[]], ReversedFNS extends [Fn, ...Fn[]] = Reverse<FNS> extends [Fn, ...Fn[]] ? Reverse<FNS> : never> = Pipe<ReversedFNS>;
export type ComposeArgs<FNS extends Fn[], result extends Fn[] = [], previousFn extends Fn | void = void, reversedFNS extends Fn[] = Reverse<FNS>> = {
