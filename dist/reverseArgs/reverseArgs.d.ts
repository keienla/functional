 ...
 */
export default function reverseArgs<Fn extends (...args: any[]) => any, R = ReturnType<Fn>, Args extends any[] = Fn extends (...args: infer A) => any ? A : []>(fn: Fn): (...args: Reverse<Args>) => R;
//# sourceMappingURL=reverseArgs.d.ts.map