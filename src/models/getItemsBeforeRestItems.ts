...
export type GetItemsBeforeRestItems<Items extends List> = IsRestItems<Items> extends true
    ? Pop<Items>
    : Items
...
type GetItemsBeforeRestItems5 = GetItemsBeforeRestItems<[hello: string, world: number | undefined]> // [hello: string, world: number | undefined]
type GetItemsBeforeRestItems6 = GetItemsBeforeRestItems<[hello: string, ...world: number[]]>        // [string]
...
type GetItemsBeforeRestItems9 = GetItemsBeforeRestItems<[hello: string, world: number[]]>           // [hello: string, world: number[]]