...
export type Pos<I extends List> =
    Length<I>

// Increment the list
export type Next<I extends List, Type extends any = any> =
    PrependItem<Type, I>

// Decrement the list
export type Prev<I extends List> =
    Tail<I>

// For loop
export type Iterator<Index extends number = 0, Type extends any = any, From extends List = [], I extends List = []> = {
