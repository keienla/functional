...
export type Before<Size extends number, BaseItems extends List, Result extends List = [], ItemsWithoutRestType extends List = GetItemsBeforeRestItems<BaseItems>, RestType = GetTypeRestItems<BaseItems>> = {
    continue: Before<Size, BaseItems, AppendList<Head<ItemsWithoutRestType>, Result>, Tail<ItemsWithoutRestType>, RestType>
    continueWithRest: Before<Size, BaseItems, AppendItem<RestType, Result>, Tail<ItemsWithoutRestType>, RestType>
    finish: Result
