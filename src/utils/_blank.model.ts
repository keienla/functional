import { AppendList, Concat, Head, IsFinite, IsNever, Length, Tail, Tuple } from "../models";
import { _BLANK } from "./_blank";

export type BLANK = typeof _BLANK

// #region IsBlank
export type IsBlank<Value, Is = true, Isnt = false> = Value extends BLANK ? Is : Isnt
...
// #region ReplaceBlank
export type ReplaceBlank<Items extends Tuple, NewItems extends Tuple> = ReplaceBlankFn<Items, NewItems>

type ReplaceBlankFn<Items extends Tuple, NewItems extends Tuple, Result extends Tuple = []> = {
    continueItems: ReplaceBlankFn<Tail<Items>, NewItems, AppendList<Head<Items>, Result>>
    continueNewItems: ReplaceBlankFn<Tail<Items>, Tail<NewItems>, AppendList<Head<NewItems>, Result>>
    finishItems: Result
...
// #region ExtractBlank
export type ExtractBlank<Given extends Tuple, Desired extends Tuple> = ExtractBlankFn<Given, Desired>

type ExtractBlankFn<Given extends Tuple, Desired extends Tuple, Result extends Tuple = []> = {
    continue: ExtractBlankFn<Tail<Given>, Tail<Desired>, Result>,
    addDesired: ExtractBlankFn<Tail<Given>, Tail<Desired>, AppendList<IsNever<Head<Desired>, [Desired[0]], Head<Desired>>, Result>>
...
type ExtractBlankTest2 = ExtractBlank<['hello'], [arg1: string, arg2: boolean, arg3: number]>       // [arg2: boolean, arg3: number]
type ExtractBlankTest3 = ExtractBlank<[BLANK, true], [arg1: string, arg2: boolean, arg3: number]>   // [arg1: string, arg3: number]
type ExtractBlankTest4 = ExtractBlank<['A', BLANK, 'C'], string[]>                                  // [string, ...string[]]
type ExtractBlankTest5 = ExtractBlank<['A', BLANK, 'C'], [string, number, ...string[]]>             // [number, ...string[]]
