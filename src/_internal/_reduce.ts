...
export const _arrayReduce = curry(function arrayReduce<T, R>(
...
export const _objectReduce = curry(function objectReduce<T extends TObject, R>(
...
export const _generatorReduce = curry(function generatorReduce<
    T extends Generator,
    R,
